// --- CONFIG ---
const ADMIN_PASSWORD = "admin26!"; // change ce mot de passe si tu veux
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // 2) Afficher le contenu admin
  if (adminContent) {
    adminContent.style.display = "block";
  }

  // 3) Brancher les boutons et logique
  ...
  // --- Vérifier / valider un billet (test admin) ---
  if (btnCheck) {
